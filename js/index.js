...
//	var help_conts = document.getElementById('help_cont');
//	var helps = document.getElementById('help');
//	var feedbacks = document.getElementById('feedback');
//	var serverCenters = document.getElementById('serverCenter');
//	document.getElementById('help_cont').onmouseover = function(){
//		helps.style.display = 'block';
//		feedbacks.style.display = 'block';
//		serverCenters.style.display = 'block';
//	}
//	document.getElementById('help_cont').onmouseout = function(){
//		helps.style.display = 'none';
//		feedbacks.style.display = 'none';
//		serverCenters.style.display = 'none';
//	}
//  悬浮工具栏结束
}